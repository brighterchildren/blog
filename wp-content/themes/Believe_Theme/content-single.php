...
<div class="entry-content<?php if ( !isset($img[0]) ) { echo ' no-image'; } ?> row-fluid">
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="post-date">
			<div class="post-day"><a href="<?php echo get_month_link(get_the_time('d'), get_the_time('m')) ?>"><?php echo $post_date_d; ?></a></div>
			<div class="post-month"><a href="<?php echo get_month_link(get_the_time('F'), get_the_time('m')) ?>"><?php echo $post_date_m; ?></a></div>
		</div>
		<div class="entry-content-c">
			<div class="clearfix"></div>
			<?php echo $entry_utility; ?>
