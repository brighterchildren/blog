...
if (!function_exists('ch_scripts_method')) {
	function ch_scripts_method() {
		...
		wp_enqueue_script('dotdotdot', get_template_directory_uri() . '/js/jquery.dotdotdot-1.5.6-packed.js', array('jquery'));
		wp_enqueue_script('modernizr.custom.97074', get_template_directory_uri() . '/js/modernizr.custom.97074.js', array('jquery'));
