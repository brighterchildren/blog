...
if (!function_exists('of_options')) {
	...
	function of_options() {
		...
		$options[] = array(
			...
			"type"  => "images",
			"options" => array(
				'full'  => $layout_style . 'layout-full.png',
				'left'  => $layout_style . 'layout-left.png',
				'right' => $layout_style . 'layout-right.png'));
		...
		$options[] = array(
			"name"  => "PayPal thank you page ID",
			"desc"  => "PayPal thank you page ID",
		...
		$options[] = array(
			...
			"desc"    => "Select the category that will be used for generating the slides.",
