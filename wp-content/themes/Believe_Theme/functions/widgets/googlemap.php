...
class ch_googlemap extends WP_Widget {
	public function ch_googlemap() {
		...
		$this->WP_Widget('gmap', __('Believe - Google map', 'ch') , $widget_options);
	}
	...
	public function widget($args, $instance) {
		...
		// Load google map JS
		if (!empty($gmap_key)) {
			wp_enqueue_script('gmap-api', 'http://maps.google.com/maps?file=api&amp;key=' . $gmap_key . '&sensor=false&amp;v=2', array(), false);
