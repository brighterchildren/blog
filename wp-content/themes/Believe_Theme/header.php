...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" <?php language_attributes(); ?>>
	<head>
		...
		<?php
			...
			if (!empty($post_input) && $post_input_array[0] != 'wp_customize=on' ) {
														...
														<li>
															<a href="<?php echo get_permalink(); ?>" class="no_thickbox">
																...
																<div <?php if ( get_post_type() != 'ch_cause' ) { echo 'class="no_bottom_border"'; } ?>>
																	...
																	<span><?php echo __( 'raised $', 'ch' ) . number_format($current_donations, 2, '.', ' '); ?></span>
																	<?php } ?>
																</div>
															</a>
														</li>
												...
												<div class="slider-container">
													<div class="featured-slides">
														...
														while ($query->have_posts()) {
															...
															// Get slide image
															$slider_image = get_the_image(array('size' => 'content-slider', 'echo' => false, 'link_to_post' => false, 'width' => 675, 'height' => 385));
